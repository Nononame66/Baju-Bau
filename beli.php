...
if (!$row) {
    echo "<script>alert('Data barang tidak ditemukan! Silakan tambah data barang terlebih dahulu.'); window.location='tambah.php';</script>";
    exit;
}
